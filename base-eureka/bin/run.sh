# description: 微服务执行脚本，提供start，stop，restart，status, log 执行
# 启动eureka时，可以使用 run.sh start --spring.profiles.active=server1  启动eureka不同server
# ......需要修改的参数 start.....
Tag="base-eureka"
#主程序启动文件
